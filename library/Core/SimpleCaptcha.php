...
class SimpleCaptcha {
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        for ($i=0; $i<$length; $i++) {
            ...
            $fontsize = rand($fontcfg['minSize']-$this->sizeCorrection,
                             $fontcfg['maxSize']-$this->sizeCorrection)*$this->scale*$fontSizefactor;
