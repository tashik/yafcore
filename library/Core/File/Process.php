...
class Core_File_Process {
    ...
    public function __construct($file, $lang = 'en_GB') {
        ...
        if ($this->lang != 'en_GB' && file_exists(dirname(__FILE__).'/lang') && file_exists(dirname(__FILE__).'/lang/class.upload.' . $lang . '.php')) {
            ...
            //logVar($this->translation, 'TRANSLATION');
        }
     ...
     */
    protected function rmkdir($path, $mode = 0777) {
     ...
     */
    protected function translate($str, $tokens = array()) {
     ...
     */
    protected function getcolors($color) {
     ...
     */
    protected function getoffsets($offsets, $x, $y, $round = true, $negative = true) {
     ...
     */
    protected function imagecreatenew($x, $y, $fill = true, $trsp = false) {
     ...
     */
    protected function imagetransfer($src_im, $dst_im) {
     ...
     * @return resource Destination image
     */
    protected function imagecopymergealpha(&$dst_im, &$src_im, $dst_x, $dst_y, $src_x, $src_y, $src_w, $src_h, $pct = 0) {
        $dst_x = (int) $dst_x;
        $dst_y = (int) $dst_y;
        $src_x = (int) $src_x;
        $src_y = (int) $src_y;
    ...
    public function process($server_path = null) {
        ...
        $this->init();
        logVar($this->log, 'RESIZE LOG');
        //logVar($this->error, 'RESIZE ERROR');
